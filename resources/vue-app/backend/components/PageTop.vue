<template>
    <div class="sm:flex gap-4 justify-between items-center rounded mb-6 p-3 py-2 bg-gradient-to-r from-red-200 to-gray-400 dark:from-red-900 dark:to-gray-400">
        ...
        <button v-if="showAddBtn" @click="formUrl ? $router.push(`/admin/items/form`) : openModal" class="mb-0 mr-0 focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-1.5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">

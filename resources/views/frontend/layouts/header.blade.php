<!-- Header -->
<header id="header" class="fixed top-0 left-0 right-0 flex items-center justify-between px-6 py-4 bg-red-100 dark:bg-gray-800 z-50">
    ...
    <!-- Profile and Search -->
    <div class="flex items-center space-x-4">
        <button class="bg-red-300 dark:bg-gray-700 px-3 py-1 rounded">Search</button>
        <details class="dropdown">
            <summary class="flex items-center cursor-pointer">
                <img src="https://via.placeholder.com/40" alt="User Profile" class="w-8 h-8 rounded-full me-1">
                Md. Al Mamun
            </summary>
            <ul class="menu dropdown-content bg-red-100 dark:bg-gray-700 rounded-box z-[1] w-52 p-2 shadow">
                <li><a>Profile</a></li>
                <li><a>History</a></li>
                <li><a>My List</a></li>
                <li><a>Logout</a></li>
...
<div id="mobileMenu" class="md:hidden hidden bg-red-100 dark:bg-gray-800">
